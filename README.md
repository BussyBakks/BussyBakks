...
public class BussyBakks {
  public static void main(String[] args) {
    ...
    private static final String RealName           = "Fkrystal Nguyen";
    ...
    private static final String Gender             = "*i love femboys*";
    private static final String Pronouns           = "it/its";
    private static final String[] Website          = {"https://fkrystal.qzz.io", "https://thenoppy12.is-a.dev", "https://thenoppy12.hopto.org"}
    private static final String Country            = "Vietnam";
    private static final String[] MinecraftIGNs    = {"thenoppy12", "FalphRalseiMC"};
    private static final String Discord            = "fkrystal.noppy";
    private static final String ContributorAt      = "rejetto/hfs";

    logger.info("Welcome to my silly page >w<")
  }
}
```
